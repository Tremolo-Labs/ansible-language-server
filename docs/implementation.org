...
2. *Modern Tooling* - Use =tree-sitter= for fast, incremental parsing with position tracking instead of slower pure-Python parsers
...
#+end_src
** Data Models
documented at [[id:data-models][Data Models]]
** Services
